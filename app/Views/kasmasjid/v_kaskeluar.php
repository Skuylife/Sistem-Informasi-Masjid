                                        ...
                                        <tbody>
                                            ...
                                            foreach ($kaskeluar as $val) {
                                                ...
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td><?= $val['jenis_kas'] ?></td>
                                                    <td>
                                                        <button type="button" class="btn btn-outline-dark btn-sm btn-edit" data-id_kasm="<?= $val['id_kaskeluar']; ?>" data-tanggal="<?= $val['tanggal']; ?>" data-ket="<?= $val['ket']; ?>" data-kasmsk="<?= $val['kas_keluar']; ?>" data-jenisk="<?= $val['jenis_kas']; ?>">
